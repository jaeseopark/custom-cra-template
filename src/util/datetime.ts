...
const SHORT_TERM_FORMAT = process.env.REACT_APP_TIME_FORMAT_SHORT_TERM || "h:mm A";
const MEDIUM_TERM_FORMAT = process.env.REACT_APP_TIME_FORMAT_MEDIUM_TERM || "dddd";
const LONG_TERM_FORMAT = process.env.REACT_APP_TIME_FORMAT_LONG_TERM || "MMM. d, YYYY";
