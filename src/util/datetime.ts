...
import { getReactEnvOrDefault } from "./env";

const DAY_IN_MS = 24 * 60 * 60 * 1000;
const WEEK_IN_MS = 7 * DAY_IN_MS;

const SHORT_TERM_FORMAT = getReactEnvOrDefault("IMF_TIME_FORMAT_SHORT_TERM", "h:mm A");
const MEDIUM_TERM_FORMAT = getReactEnvOrDefault("IMF_TIME_FORMAT_MEDIUM_TERM", "dddd");
const LONG_TERM_FORMAT = getReactEnvOrDefault("IMF_TIME_FORMAT_LONG_TERM", "MMM. d, YYYY");
